//! # Scalar optimism testnet
//!
//! Scalar OP AlphaNet is a testnet OP Stack rollup aimed at enabling experimentation of bleeding edge
...
use scalar_node::{chainspec::AlphanetChainSpecParser, node::AlphaNetNode};
use scalar_wallet::{AlphaNetWallet, AlphaNetWalletApiServer};
